...
@section('styles')
    ...
    <link href="{{asset('user/assets/css/components/cards/card.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user/plugins/table/datatable/datatables.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('user/plugins/table/datatable/custom_dt_html5.css')}}">
...
@section('scripts')
    ...
    <script src="{{asset('user/plugins/table/datatable/button-ext/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('user/plugins/table/datatable/button-ext/jszip.min.js')}}"></script>
    <script src="{{asset('user/plugins/table/datatable/button-ext/buttons.html5.min.js')}}"></script>
    <script src="{{asset('user/plugins/table/datatable/button-ext/buttons.print.min.js')}}"></script>
    @include('user.scripts.deal.delete-deal')
    <script type="text/javascript">
        $(function () {
            let table = $('#deals-datatable').DataTable({
                ...
                serverSide: true,
                cache: false,
                ajax: "{{ LaravelLocalization::localizeUrl('/startup/deals-startup/'.$startup['id']) }}",
                columns: [
