                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" name="city_name[ar]" class="form-control mb-4" id="city_name_ar" placeholder="{{__('dashboard.arabic_city_name')}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="city_name_en">{{__('dashboard.english_city_name')}}</label>
                                                                <input required type="text" name="city_name[en]" class="form-control mb-4" id="city_name_en" placeholder="{{__('dashboard.english_city_name')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
