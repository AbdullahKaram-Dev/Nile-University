                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" name="city_name[ar]" class="form-control mb-4" id="city_name_ar" value="{{$city['city_name']['ar']}}" placeholder="{{__('dashboard.city_arabic_name')}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="city_name_en">{{__('dashboard.city_english_name')}}</label>
                                                                <input required type="text" name="city_name[en]" class="form-control mb-4" id="city_name_en" value="{{$city['city_name']['en']}}" placeholder="{{__('dashboard.city_english_name')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
